...
router.post('/answer', async (req, res) => {
  ...
  try {
    const model = genAI.getGenerativeModel({ model: 'gemini-1.5-flash' });
    const prompt = `You are acting as a senior technical interviewer for ${lang.toUpperCase()}.

You are evaluating a beginner student's response to an interview question.
Provide your feedback in the following format:
